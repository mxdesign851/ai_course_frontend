//BRAND
export const name = 'Coursea';
export const company = 'Coursea';
export const websiteURL = 'https://coursea.co';
export const serverURL = 'https://aai-course-backend.vercel.app';
...
export const profession = 'CFO at Coursegen';
